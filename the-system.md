Operating systems was one of the courses of my undergrad - along with computer architecture, compilers and networks - that deciphered mysteries of the machine for me. That course was University of Waterloo's CS 350. Its elements will resonate with recent students of the class, students from many years ago, and likely computer science undergraduates everywhere. In my course we hacked NachOS, a basic operating system with a few more features than the bare bones, but many empty holes to fill in. The course packaged it for us in a way that I appreciate now, of giving a virtual machine within which the operation system could executed and debugged. For the assignments, we had to implement basic functionality for components such as the filesystem or implementing virtual memory. Working out the details of these components is a valuable and important exercise. You learn about software engineering. You learn about architecting for testing. You learn essential abstractions from the worlds of computing - processes, threads, file-system. And you learn about how some of these sub-systems are built - where they start from, and what they need to negotiate (e.g. how the filesystem is built out of raw persistent storage of bits and bytes).

As I've spent more time at the project of software, I've learned about what I would call 'the system'. These are not the details of how any single program works but rather how programs work together. Having more of an understanding of how exactly it is that a computer or a mobile phone manages to be useful, it is the coordination of these manifold pieces of software. There is much to be learned by studying this coordination.

I would advance that there are a great many _conventions_ concerning how the internals of software are arranged and how programs communicate among one another; things that aren't natural in the sense of "this is the only way it could be" kind of way (our sisters and brothers on Alpha Centauri might have developed systems that look rather different overall) but our conventions, taken together, have a harmony and a logic. So much so that each individual convention is, somehow, just right. These conventions are hard-fought achievements of the field and contain great wisdom. Wisdom of how to build sprawling software systems (and I use sprawling here affectionately and with respect to the enormous systems of our day).

With this framing in mind, let's look at a topic - environment variables - which at once might seem to be extremely mundane, so mundane as to be seldom specifically examined, and yet a topic which is fundamental.
